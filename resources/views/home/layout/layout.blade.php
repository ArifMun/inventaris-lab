                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li>
                                <a class="nav-link text-white {{ Request()->is('data-barang')? 'bg-nav' : '' }}"
                                    href="/data-barang">Daftar Barang</a>
                            </li>
                            <li>
                                <a class="nav-link text-white {{ Request()->is('kategori-barang')? 'bg-nav' : '' }}"
                                    href="/kategori-barang">Kategori</a>
                            </li>
                            <li>
                                <a class="nav-link text-white {{ Request()->is('pengadaan-barang')? 'bg-nav' : '' }}"
                            ...
                            @else
                            <li>
                                <a class="nav-link text-white" href="login"><i class="fa fa-arrow-circle-right"></i>
                                    Login
                            </li>
                            </a>
                            @endauth
